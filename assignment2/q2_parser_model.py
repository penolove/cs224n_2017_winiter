...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embedding = tf.Variable(self.pretrained_embeddings, "embedding")
    ...
    def add_prediction_op(self):
        ...
        # Layer 1
        W_initial = tf.truncated_normal([self.config.n_features * self.config.embed_size,hidden_size], stddev=0.0001)
        W=tf.Variable(W_initial)
        b1_initial = tf.truncated_normal([hidden_size], stddev=0.0001)
        ...
        # Layer 2
        U_initial = tf.truncated_normal([hidden_size,n_classes], stddev=0.0001)
        U = tf.Variable(U_initial)
        b2_initial = tf.truncated_normal([n_classes], stddev=0.0001)
